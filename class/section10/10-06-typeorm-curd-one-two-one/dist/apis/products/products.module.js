...
exports.ProductsModule = ProductsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([product_entity_1.Product, productSaleslocation_entity_1.ProductSaleslocation])],
        providers: [products_resolver_1.ProductsResolver, products_service_1.ProductsService, productsSaleslocation_service_1.ProductsSaleslocationsService],
    })
], ProductsModule);
